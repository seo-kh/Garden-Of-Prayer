...
class AdminSettingApp {
    ...
    private selectedFlower: Flower | null = null;
    ...
    // 꽃 드래그 이동 핸들링
    private initFlowerDrag(element: HTMLElement, flower: Flower) {
    ...
    private selectFlower(flower: Flower) {
        ...
        anchorCells.forEach((cell) => {
            if ((cell as HTMLElement).dataset.anchor === flower.nameAnchor) {
    ...
    private initEditorEvents() {
        ...
        anchorCells.forEach((cell) => {
            cell.addEventListener('click', () => {
                ...
                cell.classList.add('active');
                this.selectedFlower.nameAnchor = (cell as HTMLElement).dataset.anchor as NameAnchor;
                this.renderEditableFlowers();
            });
        });
    }
    ...
    private handleBgFile(file: File) {
    ...
    private initPublishModalEvents() {
