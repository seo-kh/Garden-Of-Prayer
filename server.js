...
// 1. public 폴더 내 자원을 루트(/) 기준으로 제공 (예: /ipad/ipad.js)
app.use(express.static(publicPath));

// 2. /public URL 프리픽스로 들어오는 요청도 동일하게 대응
...
// 2. 메인 씬 조회
app.get('/api/scenes/main', (req, res) => {
...
// 6. 메인 씬 지정
app.post('/api/scenes/:id/main', (req, res) => {
...
// 9. 특정 씬의 특정 꽃 정보 수정
app.put('/api/scenes/:sceneId/flowers/:flowerId', (req, res) => {
...
// 10. 특정 씬의 특정 꽃 삭제
app.delete('/api/scenes/:sceneId/flowers/:flowerId', (req, res) => {
...
// 11. 관리자 씬 게시 (Publish)
app.post('/api/scenes/:id/publish', (req, res) => {
...
io.on('connection', (socket) => {
  ...
  // 아이패드 꽃 제출 소켓 이벤트
  socket.on('submit_flower', (flowerData) => {
